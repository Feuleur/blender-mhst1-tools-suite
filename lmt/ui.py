...
class MHST1_IMPORT_PT_LmtSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST1_IMPORT_OT_mhst1_lmt"
...
class MHST1_ImportLmt(bpy.types.Operator, ImportHelper):
    """Import from Lmt file format (.lmt)"""
    bl_idname = "mhst1_import.mhst1_lmt"
    bl_label = 'Import MHST1 Lmt'
    bl_options = {'UNDO'}
    filename_ext = ".lmt"
