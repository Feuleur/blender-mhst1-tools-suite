    ...
    for bone_idx, bone_action in lmt_data["bone_action"].items():
        ...
        if "pos" in bone_action.keys():
            ...
            for time, values in pos_keyframes.items():
                ...
                keyframe_x.handle_left_type = "VECTOR"
                keyframe_x.handle_right_type = "VECTOR"

                keyframe_y = fcurve_loc_y.keyframe_points.insert(frame=int(time),value=keyframe_pos[1])
                keyframe_y.handle_left_type = "VECTOR"
                keyframe_y.handle_right_type = "VECTOR"

                keyframe_z = fcurve_loc_z.keyframe_points.insert(frame=int(time),value=keyframe_pos[2])
                keyframe_z.handle_left_type = "VECTOR"
                keyframe_z.handle_right_type = "VECTOR"
            fcurve_loc_x.keyframe_points.handles_recalc()
            fcurve_loc_y.keyframe_points.handles_recalc()
            fcurve_loc_z.keyframe_points.handles_recalc()
        if "rot" in bone_action.keys():
            ...
            for time, values in rot_keyframes.items():
                ...
                keyframe.handle_left_type = "VECTOR"
                keyframe.handle_right_type = "VECTOR"
            fcurve_rot_w.keyframe_points.handles_recalc()
            fcurve_rot_x.keyframe_points.handles_recalc()
            fcurve_rot_y.keyframe_points.handles_recalc()
            fcurve_rot_z.keyframe_points.handles_recalc()
        if "scl" in bone_action.keys():
            ...
            for time, values in scl_keyframes.items():
                    ...
                    #time = 0
                if bone_action["scl_referencial"] == "global":
                    pass
                else:
                    ...
                    keyframe.handle_left_type = "VECTOR"
                    keyframe.handle_right_type = "VECTOR"
            fcurve_scl_x.keyframe_points.handles_recalc()
            fcurve_scl_y.keyframe_points.handles_recalc()
            fcurve_scl_z.keyframe_points.handles_recalc()
