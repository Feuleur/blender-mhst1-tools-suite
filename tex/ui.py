...
class MHST1_IMPORT_PT_TexSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST1_IMPORT_OT_mhst1_tex"
...
class MHST1_IMPORT_PT_TexSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST1_IMPORT_PT_TexSettingPanel_1"
...
class MHST1_ImportTex(bpy.types.Operator, ImportHelper):
    """Import from Tex file format (.tex.*)"""
    bl_idname = "mhst1_import.mhst1_tex"
    bl_label = 'Import MHST1 Tex'
    bl_options = {'UNDO'}
    filename_ext = ".tex"
