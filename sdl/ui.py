...
class MHST1_IMPORT_PT_SdlSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST1_IMPORT_OT_mhst1_sdl"
...
class MHST1_IMPORT_PT_SdlSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST1_IMPORT_PT_SdlSettingPanel_1"
...
class MHST1_ImportSdl(bpy.types.Operator, ImportHelper):
    """Import from Sdl file format (.sdl)"""
    bl_idname = "mhst1_import.mhst1_sdl"
    bl_label = 'Import MHST1 Sdl'
    bl_options = {'UNDO'}
    filename_ext = ".sdl"
