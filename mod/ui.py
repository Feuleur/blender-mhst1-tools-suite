...
class MHST1_IMPORT_PT_ModSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST1_IMPORT_OT_mhst1_mod"
...
class MHST1_IMPORT_PT_ModSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST1_IMPORT_PT_ModSettingPanel_1"
...
class MHST1_ImportMod(bpy.types.Operator, ImportHelper):
    """Import from Mod file format (.mod)"""
    bl_idname = "mhst1_import.mhst1_mod"
    bl_label = 'Import MHST1 Mod'
    bl_options = {'UNDO'}
    filename_ext = ".mod"
